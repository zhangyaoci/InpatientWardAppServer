        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="./user.jsp">病人家属管理模块</a></li>
                </ul>
    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="list-group" >
                <a href="javascript:void(0)" name="page/user_info.jsp"  class="list-group-item ">用户基本信息</a>
                <a href="javascript:void(0)" name="page/user_relation.jsp"  class="list-group-item ">用户病人关系管理</a>
            </div>
        </div>
